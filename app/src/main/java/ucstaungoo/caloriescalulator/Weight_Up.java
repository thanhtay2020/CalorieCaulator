...
public class Weight_Up  extends AppCompatActivity {
    //Button btn;
    ...
    private String cw,h,a,gw,radio;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.weight_up);
       ...
       currentweight=findViewById(R.id.currentweight);
        ...
        button=findViewById(R.id.weightup);
...
//
//        currentweight1=Double.valueOf(cw).doubleValue();
//        height1=Double.valueOf(h).doubleValue();
//        goalweight1=Double.valueOf(gw).doubleValue();
//
//
//        age1=Integer.valueOf(a).intValue();
